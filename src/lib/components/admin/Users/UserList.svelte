...
{:else}
  ...
  >
    <div class="flex gap-2 px-0.5 text-lg font-medium md:self-center">
  ...
  <div class="scrollbar-hidden relative max-w-full overflow-x-auto whitespace-nowrap">
    <table class="w-full max-w-full table-auto text-left text-sm text-gray-500 dark:text-gray-400">
            ...
            <td class="max-w-48 px-3 py-1 font-medium text-gray-900 dark:text-white">
              <div class="flex items-center gap-2">
                <ProfilePreview {user} side="right" align="center" sideOffset={6}>
                  <img
                    class="mr-0.5 h-6 w-6 min-w-6 flex-shrink-0 rounded-full object-cover"
              ...
              <div class="flex w-full justify-end">
                {#if $config.features.enable_admin_chat_access && user.role !== 'admin'}
                  <Tooltip content={$i18n.t('Chats')}>
                    <button
                      class="w-fit self-center rounded-xl px-2 py-2 text-sm hover:bg-black/5 dark:hover:bg-white/5"
