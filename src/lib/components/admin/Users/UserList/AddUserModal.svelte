...
<Modal size="sm" bind:show>
  <div>
    ...
    <div class="flex w-full flex-col px-4 pb-3 md:flex-row md:space-x-4 dark:text-gray-200">
      <div class=" flex w-full flex-col sm:flex-row sm:justify-center sm:space-x-6">
        ...
        >
          <div
            class="scrollbar-none -mt-2 mb-1.5 flex w-fit gap-1 overflow-x-auto rounded-full bg-transparent text-center text-sm font-medium dark:text-gray-200"
          >
            <button
              class="min-w-fit p-1.5 {tab === ''
                ? ''
                : 'text-gray-300 hover:text-gray-700 dark:text-gray-600 dark:hover:text-white'} transition"
              type="button"
              on:click={() => {
                tab = '';
              }}>{$i18n.t('Form')}</button
          ...
          <div class="px-1">
            {#if tab === ''}
              <div class="mb-3 flex w-full flex-col">
                ...
                <div class="flex-1">
                  <select
                    class="w-full rounded-lg bg-transparent text-sm capitalize outline-hidden dark:disabled:text-gray-500"
              ...
              <hr class=" dark:border-gray-850/30 my-2.5 w-full border-gray-100/30" />
            ...
            {:else if tab === 'import'}
              <div>
                <div class="mb-3 w-full">
                  ...
                  <button
                    class="dark:border-gray-850 dark:hover:bg-gray-850 w-full rounded-xl border border-dashed bg-transparent py-3 text-center text-sm font-medium hover:bg-gray-100"
                    type="button"
                    on:click={() => {
