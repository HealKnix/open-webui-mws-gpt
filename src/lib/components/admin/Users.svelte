...
<div class="flex h-full w-full flex-col pb-2 lg:flex-row lg:space-x-4">
  <div
    ...
    class="scrollbar-none mx-[16px] flex max-w-full flex-row gap-2.5 overflow-x-auto text-left text-sm font-medium lg:mx-0 lg:w-50 lg:flex-none lg:flex-col lg:gap-1 lg:px-[16px] dark:text-gray-200"
  >
    <a
      id="overview"
