  ...
  <div class="scrollbar-hidden h-full space-y-3 overflow-y-scroll p-1">
    {#if webConfig}
      <div class="space-y-1">
        ...
        <ToggleSetting label={$i18n.t('Web Search')} bind:state={webConfig.ENABLE_WEB_SEARCH} />

        <SettingItem label={$i18n.t('Web Search Engine')}>
          <select
        ...
        {#if webConfig.WEB_SEARCH_ENGINE !== ''}
          {#if webConfig.WEB_SEARCH_ENGINE === 'ollama_cloud'}
            <div class="mb-2.5 flex w-full flex-col">
              <div>
                <div class=" mb-1 self-center text-xs font-medium">
          ...
          {:else if webConfig.WEB_SEARCH_ENGINE === 'searxng'}
            <div class="mb-2.5 flex w-full flex-col">
              <div>
                <div class=" self-left mb-1 text-xs font-medium">
        ...
        <ToggleSetting
          ...
          tooltip={webConfig.BYPASS_WEB_SEARCH_EMBEDDING_AND_RETRIEVAL
            ? $i18n.t(
        ...
        <ToggleSetting
          ...
          bind:state={webConfig.BYPASS_WEB_SEARCH_WEB_LOADER}
        />

        <ToggleSetting
          label={$i18n.t('Trust Proxy Environment')}
          bind:state={webConfig.WEB_SEARCH_TRUST_ENV}
          tooltip={webConfig.WEB_SEARCH_TRUST_ENV
            ? $i18n.t(
      ...
      <div class="space-y-1">
        ...
        <SettingItem label={$i18n.t('Web Loader Engine')}>
          <select
            class="w-fit rounded-sm bg-transparent p-1 px-2 pr-8 text-right text-xs outline-hidden"
        ...
        {#if webConfig.WEB_LOADER_ENGINE === '' || webConfig.WEB_LOADER_ENGINE === 'safe_web'}
          <SettingItem label={$i18n.t('Timeout')}>
            <div class="relative flex items-center">
              <input
                class="w-full flex-1 bg-transparent text-right text-sm font-medium outline-hidden"
        ...
        <SettingItem label={$i18n.t('Youtube Language')}>
          <input
            class="w-full flex-1 rounded-lg bg-transparent text-right text-sm outline-hidden"
            type="text"
        ...
        <SettingItem label={$i18n.t('Youtube Proxy URL')}>
          <div class="relative flex w-full max-w-64 items-center">
            <input
              class="w-full flex-1 rounded-lg bg-transparent text-right text-sm outline-hidden"
              type="text"
