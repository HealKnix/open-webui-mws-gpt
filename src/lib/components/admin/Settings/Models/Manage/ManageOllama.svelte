    ...
    <div>
      <div class="space-y-2">
        <div>
          <div class=" mb-2 flex items-center gap-1.5 text-sm font-medium">
            ...
            <div>
              <Tooltip content="Update All Models" placement="top">
                <button
                  class="flex items-center gap-2 rounded-lg bg-transparent transition"
                  on:click={() => {
                    updateModelsHandler();
                  }}
                >
          ...
          <div class="flex w-full">
            ...
            <Tooltip content={$i18n.t('Pull Model')} placement="top">
              <button
                class="dark:bg-gray-850 rounded-lg bg-gray-50 px-2.5 text-gray-800 transition hover:bg-gray-200 dark:text-gray-100 dark:hover:bg-gray-800"
                on:click={() => {
                  pullModelHandler();
                }}
          ...
          <div class="mt-2 mb-1 text-xs text-gray-400 dark:text-gray-500">
            ...
            <a
              class=" font-medium text-gray-500 underline dark:text-gray-300"
            ...
            {#each Object.keys($MODEL_DOWNLOAD_POOL) as model}
              {#if 'pullProgress' in $MODEL_DOWNLOAD_POOL[model]}
                <div class="flex flex-col">
                  <div class="mb-1 font-medium">{model}</div>
                  <div class="">
                    <div class="flex flex-row justify-between space-x-4 pr-2">
                      <div class=" flex-1">
                        <div
                          class="rounded-full bg-gray-500 p-0.5 text-center text-xs leading-none font-medium text-gray-100 dark:bg-gray-600"
        ...
        <div>
          ...
          <div class="flex w-full">
            <div
              class="dark:bg-gray-850 mr-2 flex-1 rounded-lg bg-gray-50 pr-1.5 dark:text-gray-300"
            >
              <select
                class="w-full bg-transparent px-4 py-2 text-sm outline-hidden"
        ...
        <div>
          ...
          <div class="flex w-full">
            <div class="mr-2 flex flex-1 flex-col gap-2">
              <input
                class="dark:bg-gray-850 w-full rounded-lg bg-gray-50 px-4 py-2 text-sm outline-hidden dark:text-gray-300"
                placeholder={$i18n.t('Enter model tag (e.g. {{modelTag}})', {
              ...
              <textarea
                ...
                class="dark:bg-gray-850 scrollbar-hidden w-full resize-none rounded-lg bg-gray-50 px-4 py-2 text-sm outline-hidden dark:text-gray-100"
                rows="6"
            ...
            <div class="flex self-start">
              <Tooltip content={$i18n.t('Create Model')} placement="top">
                <button
                  class="dark:bg-gray-850 rounded-lg bg-gray-50 px-2.5 py-2.5 text-gray-800 transition hover:bg-gray-200 disabled:cursor-not-allowed dark:text-gray-100 dark:hover:bg-gray-800"
                  on:click={() => {
                    createModelHandler();
                  }}
                  disabled={createModelLoading ||
          ...
          {#if createModelDigest !== ''}
            <div class="mt-1 flex flex-col">
              <div class="mb-1 font-medium">{createModelTag}</div>
              <div class="">
                <div class="flex flex-row justify-between space-x-4 pr-2">
                  <div class=" flex-1">
                    <div
            ...
            <div class="mb-1.5 flex w-full">
              <div class="flex w-full flex-col">
                {#if modelUploadMode === 'file'}
                  <div class="flex-1 {modelInputFile && modelInputFile.length > 0 ? 'mr-2' : ''}">
                    ...
                    <button
                      type="button"
                      class="dark:bg-gray-850 w-full rounded-lg bg-gray-50 px-4 py-2 text-left dark:text-gray-300"
                      on:click={() => {
                ...
                {:else}
                  <div class="flex-1 {modelFileUrl !== '' ? 'mr-2' : ''}">
                    <input
                      class="dark:bg-gray-850 w-full rounded-lg bg-gray-50 px-4 py-2 text-left outline-hidden dark:text-gray-300 {modelFileUrl !==
                      ''
                        ? 'mr-2'
                        : ''}"
                      type="url"
              ...
              {#if (modelUploadMode === 'file' && modelInputFile && modelInputFile.length > 0) || (modelUploadMode === 'url' && modelFileUrl !== '')}
                <Tooltip content={$i18n.t('Upload Model')} placement="top">
                  <button
                    class="dark:bg-gray-850 rounded-lg bg-gray-50 px-2.5 text-gray-800 transition hover:bg-gray-200 disabled:cursor-not-allowed dark:text-gray-100 dark:hover:bg-gray-800"
                    type="submit"
              ...
              <div>
                <div>
                  ...
                  <textarea
                    ...
                    class="dark:bg-gray-850 w-full resize-none rounded-lg bg-gray-50 px-4 py-2 text-sm outline-hidden dark:text-gray-100"
                    rows="6"
                  />
                </div>
              </div>
...
{:else if ollamaModels === null}
  <div class="flex h-full w-full items-center justify-center py-3 text-xs">
    {$i18n.t('Failed to fetch models')}
  </div>
{:else}
  <div class="flex h-full w-full items-center justify-center py-3">
