...
<Modal size="sm" bind:show>
  <div>
    <div class=" flex justify-between px-5 pt-4 dark:text-gray-100">
    ...
    <div class="flex w-full flex-col px-3 pb-4 md:flex-row md:space-x-4 dark:text-gray-200">
      <div class=" flex w-full flex-col sm:flex-row sm:justify-center sm:space-x-6">
        {#if selected === ''}
          <div class=" py-5 text-xs text-gray-400">
            <div>
        ...
        {:else if selected !== null}
          <div class=" flex w-full flex-col">
            <div
              class="scrollbar-none flex w-fit gap-1 overflow-x-auto rounded-full bg-transparent text-center text-sm font-medium dark:text-gray-200"
            >
              <button
