  ...
  <div class="scrollbar-hidden h-full overflow-y-scroll">
    {#if PIPELINES_LIST !== null}
      ...
      {#if PIPELINES_LIST.length > 0}
        ...
        <div class=" my-2">
          ...
          <div class="flex w-full">
            <div class="mr-2 flex-1">
              ...
              <button
                class="dark:border-gray-850 dark:hover:bg-gray-850 w-full rounded-xl border border-dashed bg-transparent py-2 text-center text-sm font-medium hover:bg-gray-100"
                type="button"
                on:click={() => {
            ...
            <button
              class="dark:bg-gray-850 rounded-lg bg-gray-100 px-2.5 text-gray-800 transition hover:bg-gray-200 dark:text-gray-100 dark:hover:bg-gray-800"
              on:click={() => {
        ...
        <hr class="dark:border-gray-850/30 my-3 w-full border-gray-100/30" />
                  ...
                  {#if valves}
                    {#each Object.keys(valves_spec.properties) as property, idx}
                      <div class=" w-full justify-between py-0.5">
                        ...
                        {#if (valves[property] ?? null) !== null}
                          <!-- {valves[property]} -->
                          <div class="mt-0.5 mb-1.5 flex space-x-2">
                            <div class=" flex-1">
