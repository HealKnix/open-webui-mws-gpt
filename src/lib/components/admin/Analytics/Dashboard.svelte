...
<div
  class="sticky top-0 z-10 flex flex-row items-center justify-between gap-1 bg-white pt-0.5 pb-1 dark:bg-gray-900"
>
  <div class="px-0.5 text-lg font-medium">
    {$i18n.t('Analytics')}
  </div>
  <div class="flex items-center gap-2">
    {#if groups.length > 0}
      <select
        ...
        class="w-fit rounded-sm bg-transparent px-2 pr-8 text-right text-xs outline-none"
      >
...
<!-- Summary stats -->
{#if !loading}
  <div class="flex gap-3 px-0.5 pb-2 text-xs text-gray-500 dark:text-gray-400">
    <span
  ...
  {#if dailyStats.length > 1}
    ...
    <div class="mb-4">
      <div class="mb-2 px-0.5 text-xs font-medium text-gray-600 dark:text-gray-400">
...
{:else}
  <div class="grid gap-4 md:grid-cols-2">
    <!-- Model Usage Table -->
    <div>
      <div class="mb-1 px-0.5 text-xs font-medium text-gray-700 dark:text-gray-300">
        {$i18n.t('Model Usage')}
      </div>
        ...
        <table class="w-full table-auto text-left text-sm text-gray-500 dark:text-gray-400">
          <thead class="bg-transparent text-xs text-gray-800 uppercase dark:text-gray-200">
            <tr class="dark:border-gray-850/30 border-b-[1.5px] border-gray-50">
              ...
              <th
                scope="col"
                class="w-16 cursor-pointer px-2.5 py-2 text-right select-none"
          ...
          <tbody>
            {#each sortedModels as model, idx (model.model_id)}
              <tr
                class="dark:border-gray-850 cursor-pointer bg-white text-xs transition-colors hover:bg-gray-50 dark:bg-gray-900 dark:hover:bg-gray-800"
                on:click={() => {
              ...
              >
                ...
                <td class="px-3 py-1 font-medium text-gray-900 dark:text-white">
                  <div class="flex items-center gap-2">
                    ...
                    />
                    <span class="max-w-[150px] truncate">{model.name}</span>
                  </div>
                </td>
  ...
  <div class="mt-1.5 text-right text-xs text-gray-500">
