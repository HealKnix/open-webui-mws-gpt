...
<div class="flex flex-col gap-4 p-4">
  ...
  <!-- Settings -->
  {#if settings.enabled}
    <div class="space-y-4 rounded-lg bg-gray-50 p-3 dark:bg-gray-800">
      ...
      <div class="grid grid-cols-2 gap-4">
        <div>
          ...
          <input
            ...
            on:change={saveSettings}
            class="w-full rounded-lg border px-3 py-2 dark:border-gray-600 dark:bg-gray-700"
          />
  ...
  {#if activeSegment}
    <div class="rounded-lg bg-blue-50 p-3 dark:bg-blue-900/20">
      <h4 class="mb-2 font-medium">{$i18n.t('Current Summary')}</h4>
      ...
      {#if activeSegment.summary_text}
        <div class="mt-3 rounded bg-white p-2 text-sm dark:bg-gray-800">
    ...
    <div class="space-y-2">
      ...
      <div class="max-h-48 space-y-2 overflow-y-auto">
        {#each segments as segment}
          <div class="rounded bg-gray-50 p-2 text-sm dark:bg-gray-800">
            <div class="flex items-center justify-between">
