...
{:else}
  ...
  >
    {#if isDragOver}
      <div
        class="dark:bg-gray-850/80 pointer-events-none absolute inset-0 z-10 flex flex-col items-center justify-center gap-1.5 bg-white/80 backdrop-blur-sm"
      >
        <svg
      ...
      >
        {#if fileImageUrl !== null || (fileOfficeSlides !== null && fileOfficeSlides.length > 0)}
          <Tooltip content={$i18n.t('Reset view')}>
            <button
              class="shrink-0 rounded p-1 text-gray-400 transition hover:bg-gray-100 hover:text-gray-600 dark:text-gray-500 dark:hover:bg-gray-800 dark:hover:text-gray-400"
          ...
          {#if creatingFolder}
            <div class="flex items-center gap-2 px-3 py-1.5">
              ...
              <input
                ...
                class="flex-1 rounded border border-gray-200 bg-transparent px-1.5 py-0.5 text-xs outline-none focus:border-blue-400 dark:border-gray-700 dark:focus:border-blue-500"
    ...
    {#if terminalEnabled}
      <div class="dark:bg-gray-850 shrink-0 border-t border-gray-100 bg-white dark:border-gray-800">
        {#if terminalExpanded}
          <!-- Drag handle (at top of panel) -->
          <!-- svelte-ignore a11y-no-static-element-interactions -->
          <div class="group relative cursor-row-resize" on:mousedown={onHandleMouseDown}>
            <div
              class="h-px bg-transparent transition group-hover:bg-black/10 dark:group-hover:bg-white/10"
            />
        ...
        <button
          class="mb-0.5 flex w-full items-center gap-2 px-3 py-1 text-xs text-gray-500 transition hover:bg-gray-50 dark:text-gray-400 dark:hover:bg-gray-800/50"
        ...
        >
          ...
          {#if terminalExpanded}
            <div
              class="h-1.5 w-1.5 rounded-full transition-colors {terminalConnected
                ? 'bg-emerald-500'
                : terminalConnecting
          ...
          <svg
            ...
            viewBox="0 0 20 20"
            fill="currentColor"
            class="ml-auto size-3 transition-transform {terminalExpanded ? 'rotate-180' : ''}"
          >
            <path
              fill-rule="evenodd"
