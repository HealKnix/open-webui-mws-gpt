...
<div class="flex shrink-0 items-center gap-1 px-2 pb-1.5">
  ...
  <Tooltip content={$i18n.t('Back')}>
    <button
      class="shrink-0 rounded p-1 transition {canGoBack
  ...
  <Tooltip content={$i18n.t('Forward')}>
    <button
      class="shrink-0 rounded p-1 transition {canGoForward
        ? 'text-gray-400 hover:bg-gray-100 hover:text-gray-600 dark:text-gray-500 dark:hover:bg-gray-800 dark:hover:text-gray-400'
        : 'cursor-default text-gray-200 dark:text-gray-700'}"
  ...
  >
    {#each breadcrumbs as crumb, i}
      {#if i > 1}
        <span class="mx-0.5 shrink-0 text-xs text-gray-300 select-none dark:text-gray-600">/</span>
      {/if}
      <button
        class="shrink-0 rounded px-1 py-0.5 text-xs transition hover:bg-gray-100 dark:hover:bg-gray-800
