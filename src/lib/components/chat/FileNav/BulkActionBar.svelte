...
<div class="flex shrink-0 items-center gap-2 bg-gray-50 px-3 py-1.5 dark:bg-gray-800/50">
  <span class="flex-1 truncate text-xs font-medium text-gray-600 dark:text-gray-400">
