...
<Modal bind:show size="md">
  <div>
    <div class=" flex justify-between px-5 pt-4 pb-2 dark:text-gray-300">
      <div class=" self-center text-lg font-medium">{$i18n.t('Input Variables')}</div>
      <button
        class="self-center"
        on:click={() => {
          show = false;
      ...
      <div class=" flex w-full flex-col sm:flex-row sm:justify-center sm:space-x-6">
        ...
        >
              ...
              <div class="flex flex-col gap-1">
                {#each Object.keys(variables) as variable, idx}
                  ...
                  <div class=" w-full justify-between py-0.5">
                    ...
                    <div class="mt-0.5 mb-0.5 flex space-x-2">
                      <div class=" flex-1">
                        {#if variables[variable]?.type === 'select'}
                          ...
                          <select
                            class="dark:bg-gray-850 dark:border-gray-850/30 w-full rounded-lg border border-gray-100/30 px-4 py-2 text-sm outline-hidden dark:text-gray-300"
                          ...
                          <div class="flex items-center space-x-2">
                            <div class="relative flex items-center justify-center gap-2">
                              <input
                                ...
                                class="size-3.5 cursor-pointer rounded border border-gray-200 dark:border-gray-700"
                                id="input-variable-{idx}"
                                {...variableAttributes}
                              />
                            ...
                            <input
                              type="text"
                              class="flex-1 bg-transparent py-1 text-sm outline-hidden dark:text-gray-300"
                        ...
                        {:else if variables[variable]?.type === 'color'}
                          <div class="flex items-center space-x-2">
                            <div class="relative size-6">
                              <input
                                type="color"
                                class="size-6 cursor-pointer rounded border border-gray-200 dark:border-gray-700"
                            ...
                            <input
                              type="text"
                              class="flex-1 bg-transparent py-2 text-sm outline-hidden dark:text-gray-300"
                          ...
                          <div class="flex items-center space-x-2">
                            <div class="relative flex flex-1 items-center justify-center gap-2">
                              <input
                                type="range"
                                bind:value={variableValues[variable]}
                                class="dark:bg-gray-850 dark:border-gray-850/30 w-full rounded-lg border border-gray-100/30 px-4 py-1 text-sm outline-hidden dark:text-gray-300"
                                id="input-variable-{idx}"
                                {...variableAttributes}
                              />
                            </div>
                            ...
                            <input
                              type="text"
                              class=" bg-transparent py-1 text-right text-sm outline-hidden dark:text-gray-300"
                        ...
                        {:else if variables[variable]?.type === 'map'}
                          ...
                          <div class="flex flex-col items-center gap-1">
                            ...
                            <input
                              type="text"
                              class=" w-full bg-transparent py-1 text-left text-sm outline-hidden dark:text-gray-300"
          ...
          <div class="flex justify-end pt-3 text-sm font-medium">
            <button
              class="rounded-full bg-white px-3.5 py-1.5 text-sm font-medium text-black transition hover:bg-gray-100 dark:bg-black dark:text-white dark:hover:bg-gray-900"
              type="button"
              on:click={() => {
                show = false;
              }}
