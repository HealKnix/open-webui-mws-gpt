...
>
  ...
  <div slot="content">
    <div
      class="dark:bg-gray-850 scrollbar-thin z-50 max-h-72 w-70 overflow-x-hidden overflow-y-auto rounded-2xl border border-gray-100 bg-white px-1 py-1 shadow-lg transition dark:border-gray-800 dark:text-white"
    >
      {#if tab === ''}
        <div in:fly={{ x: -20, duration: 150 }}>
          ...
          >
            <button
              class="flex w-full cursor-pointer items-center gap-2 rounded-xl px-3 py-1.5 text-sm select-none hover:bg-gray-50 dark:hover:bg-gray-800/50 {!fileUploadEnabled
                ? 'opacity-50'
                : ''}"
              type="button"
              on:click={() => {
          ...
          >
            <button
              class="flex w-full cursor-pointer items-center gap-2 rounded-xl px-3 py-1.5 text-sm select-none hover:bg-gray-50 dark:hover:bg-gray-800 {!webUploadEnabled
                ? 'opacity-50'
                : ''}"
              type="button"
              on:click={() => {
          ...
          >
            <button
              class="flex w-full cursor-pointer items-center gap-2 rounded-xl px-3 py-1.5 text-sm hover:bg-gray-50 dark:hover:bg-gray-800/50 {!fileUploadEnabled
                ? 'opacity-50'
                : ''}"
              on:click={() => {
                tab = 'knowledge';
      ...
      {:else if tab === 'knowledge'}
        <div in:fly={{ x: 20, duration: 150 }}>
          <button
            class="flex w-full cursor-pointer items-center justify-between gap-2 rounded-xl px-3 py-1.5 text-sm select-none hover:bg-gray-50 dark:hover:bg-gray-800/50"
            on:click={() => {
              tab = '';
            }}
          >
      ...
      {:else if tab === 'microsoft_onedrive'}
        <div in:fly={{ x: 20, duration: 150 }}>
          ...
          {#if $config?.features?.enable_onedrive_personal}
            <button
              class="flex w-full cursor-pointer items-center gap-2 rounded-xl px-3 py-1.5 text-left text-sm select-none hover:bg-gray-50 dark:hover:bg-gray-800/50"
              type="button"
              on:click={() => {
