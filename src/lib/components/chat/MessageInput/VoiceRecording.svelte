...
<div
  ...
  class="{loading
    ...
    : 'bg-indigo-300/10 dark:bg-indigo-500/10 '} flex justify-between rounded-full {className}"
>
  ...
  <div
    class="mx-1 ml-2 flex h-6 flex-1 items-center justify-between self-center overflow-hidden"
    dir="rtl"
  >
    <div
      class="flex h-6 w-full max-w-full flex-wrap items-center gap-0.5 overflow-hidden overflow-x-hidden"
    >
  ...
  <div class="flex">
    <div class="  mx-1.5 flex items-center justify-center pr-1">
      <div
        class="text-sm
        
        
        {loading ? ' text-gray-500  dark:text-gray-400  ' : ' text-indigo-400 '} 
       mx-auto flex-1 text-center font-medium"
      >
    ...
    <div class="flex items-center">
      {#if loading}
        <div class=" cursor-not-allowed rounded-full text-gray-500">
          <svg
            width="24"
            height="24"
            viewBox="0 0 24 24"
      ...
      {:else}
        <button
          ...
          type="button"
          class="rounded-full bg-indigo-500 p-1.5 text-white dark:bg-indigo-500 dark:text-blue-950"
          on:click={async () => {
