                ...
                <div class="flex w-full flex-col">
                  ...
                  {#each policyEnvPairs as pair, idx}
                    <div class="mb-1 flex gap-1.5">
                      <input
                        class={`flex-1 bg-transparent font-mono text-sm ${($settings?.highContrastMode ?? false) ? 'placeholder:text-gray-700 dark:placeholder:text-gray-100' : 'outline-hidden placeholder:text-gray-300 dark:placeholder:text-gray-700'}`}
                        type="text"
                        bind:value={pair.key}
                        placeholder="KEY"
                      />
                      <input
                        class={`flex-[2] bg-transparent font-mono text-sm ${($settings?.highContrastMode ?? false) ? 'placeholder:text-gray-700 dark:placeholder:text-gray-100' : 'outline-hidden placeholder:text-gray-300 dark:placeholder:text-gray-700'}`}
                        type="text"
                      ...
                      <button
                        type="button"
                        class="px-1 text-xs text-gray-400 transition hover:text-gray-700 dark:hover:text-gray-200"
                        on:click={() =>
