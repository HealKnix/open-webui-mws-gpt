          ...
          <div class=" flex-1">
            ...
            {:else if valvesSpec.properties[property]?.input ?? null}
              {#if valvesSpec.properties[property]?.input?.type === 'password'}
                <div
                  class="dark:bg-gray-850 dark:border-gray-850/30 w-full rounded-lg border border-gray-100/30 px-4 py-2 text-sm dark:text-gray-300"
                >
                  <SensitiveInput
                    id="valve-{property}"
              ...
              {:else if valvesSpec.properties[property]?.input?.type === 'color'}
                <div class="flex items-center space-x-2">
                  ...
                  <input
                    type="text"
                    class="dark:bg-gray-850 dark:border-gray-850/30 flex-1 rounded-lg border border-gray-100/30 py-2 text-sm outline-hidden dark:text-gray-300"
              ...
              {:else if valvesSpec.properties[property]?.input?.type === 'map'}
                ...
                <div class="flex flex-col items-center gap-1">
                  ...
                  {#if valves[property]}
                    <input
                      type="text"
                      class=" dark:bg-gray-850 dark:border-gray-850/30 w-full rounded-lg border border-gray-100/30 py-1 text-left text-sm outline-hidden dark:text-gray-300"
