...
{#if show}
  ...
  <div
    ...
    class="modal fixed top-0 right-0 bottom-0 left-0 z-9999 flex h-screen min-h-screen w-full justify-center overflow-hidden overscroll-contain bg-black text-white"
  >
    <div class=" absolute left-0 z-20 flex w-full justify-between select-none">
      <div>
        <button
          class=" p-5"
          on:pointerdown={(e) => {
    ...
    <div class="z-0 flex h-full max-h-full items-center justify-center">
      <img
