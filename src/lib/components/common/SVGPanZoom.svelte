...
<div bind:this={sceneParentElement} class="relative {className}">
  <div bind:this={sceneElement} class="flex h-full max-h-full items-center justify-center">
    ...
    <div class=" absolute top-2.5 right-2.5">
      <div class="flex gap-1">
        <Tooltip content={$i18n.t('Download as SVG')}>
          <button
            class="dark:bg-gray-850 rounded-lg border border-gray-100 p-1.5 transition hover:bg-gray-50 dark:border-none dark:hover:bg-gray-800"
            on:click={() => {
              downloadAsSVG();
            }}
          >
