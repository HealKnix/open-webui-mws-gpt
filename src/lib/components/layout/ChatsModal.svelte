          ...
          <div class="w-full">
            {#if chatList.length > 0}
              <div class="mb-1.5 flex text-xs font-medium">
                ...
                {/if}
                <button
                  class="cursor-pointer px-1.5 py-1 select-none {showUserInfo
                    ? 'flex-1'
                    : 'basis-3/5'}"
                ...
                <button
                  class="hidden cursor-pointer px-1.5 py-1 select-none sm:flex {showUserInfo
                    ? 'w-28'
                      ...
                      <div class="flex justify-end pl-2.5 text-gray-600 dark:text-gray-300">
                        {#if unarchiveHandler}
                          <Tooltip content={$i18n.t('Unarchive Chat')}>
                            <button
                              class="w-fit self-center rounded-xl px-1 text-sm"
                              on:click={async (e) => {
