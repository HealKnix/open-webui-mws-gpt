...
<Modal size="xl" bind:show>
  <div class="py-3 text-gray-700 dark:text-gray-300">
    ...
    <div class="flex px-4 pb-1">
      ...
      >
        <div class="w-full px-2 pb-2 text-xs font-medium text-gray-500 dark:text-gray-500">
          {$i18n.t('Actions')}
        </div>

        {#each actions as action, idx (action.label)}
          <button
            class=" dark:hover:bg-gray-850 flex w-full items-center rounded-xl px-3 py-2 text-sm hover:bg-gray-50 {selectedIdx ===
            idx
        ...
        {#if chatList}
          <hr class="dark:border-gray-850/30 my-3 border-gray-50" />
          ...
          {#each chatList as chat, idx (chat.id)}
            ...
            <a
              class=" dark:hover:bg-gray-850 flex w-full items-center justify-between rounded-xl px-3 py-2 text-sm hover:bg-gray-50 {selectedIdx ===
              idx + actions.length
                ? 'dark:bg-gray-850 bg-gray-50'
                : ''}"
              href="/c/{chat.id}"
            ...
            >
              ...
              <div class=" shrink-0 pl-3 text-xs text-gray-500 dark:text-gray-400">
                {$i18n.t(
