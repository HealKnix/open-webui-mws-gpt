  ...
  <div>
    ...
    <div class="flex w-full flex-col px-5 pb-4 md:flex-row md:space-x-4 dark:text-gray-200">
      <div class=" flex w-full flex-col sm:flex-row sm:justify-center sm:space-x-6">
        ...
        >
          {#if !edit}
            <div class="mt-2 mb-1 flex w-full flex-col">
          ...
          <div class="mt-2 flex w-full flex-col">
            <div class=" mb-1 text-xs text-gray-500">
              {$i18n.t('Channel Name')}
              <span class="ml-0.5 text-xs text-gray-200 dark:text-gray-800"
          ...
          {#if type !== 'dm'}
            <div class="-mx-2 mt-2.5 mb-1 px-2">
              {#if type === ''}
          ...
          {#if edit}
            <div class="mt-2 flex w-full items-center justify-between">
              ...
              <button
                class="bg-transparent text-left text-xs outline-hidden placeholder:text-gray-300 dark:placeholder:text-gray-700"
                type="button"
                on:click={() => {
          ...
          <div class="flex justify-end gap-1.5 pt-3 text-sm font-medium">
            {#if edit}
              <button
                class="flex flex-row items-center space-x-1 rounded-full bg-white px-3.5 py-1.5 text-sm font-medium text-black transition hover:bg-gray-100 dark:bg-black dark:text-white dark:hover:bg-black/90"
                type="button"
                on:click={() => {
