...
<div class="relative z-10 mb-1 flex justify-center space-x-2 px-1" id="search-container">
  <div class="flex w-full rounded-xl" id="chat-search">
    <div class="self-center rounded-l-xl bg-transparent py-2 dark:text-gray-300">
      <Search />
    </div>

    <input
      id="search-input"
      class="w-full rounded-r-xl bg-transparent py-1.5 pl-2.5 text-sm outline-hidden dark:text-gray-300"
  ...
  {#if focused && (filteredOptions.length > 0 || filteredItems.length > 0)}
    ...
    <div
      class="absolute top-0 right-1 left-0 z-10 mt-8 rounded-2xl border border-gray-100 bg-gray-50 shadow-lg dark:border-gray-900 dark:bg-gray-950"
    ...
    >
      <div class="group px-3 py-2.5 text-xs">
        {#if filteredItems.length > 0}
          <div class="mb-1 px-1 font-medium text-gray-700 capitalize dark:text-gray-300">
            {selectedOption}
          </div>
          ...
          <div class="max-h-60 overflow-auto">
            {#each filteredItems as item, itemIdx}
              <button
                class=" flex w-full gap-1 rounded px-1.5 py-0.5 hover:bg-gray-100 dark:hover:bg-gray-900 {selectedIdx ===
                itemIdx
              ...
              >
                <div class="line-clamp-1 shrink-0 font-medium text-gray-700 dark:text-gray-300">
                  {item.name}
                </div>
        ...
        {:else if filteredOptions.length > 0}
          <div class="mb-1 px-1 font-medium text-gray-700 dark:text-gray-300">
          ...
          <div class=" max-h-60 overflow-auto">
            {#each filteredOptions as option, optionIdx}
              ...
              >
                <div class="font-medium text-gray-700 dark:text-gray-300">{option.name}</div>
