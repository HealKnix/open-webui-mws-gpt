...
>
  ...
  <div slot="content">
    <div
      class="dark:bg-gray-850 z-50 min-w-[200px] rounded-2xl border border-gray-100 bg-white px-1 py-1 shadow-lg transition select-none dark:border-gray-800 dark:text-white"
    >
