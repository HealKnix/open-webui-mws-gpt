...
>
  <div class=" mb-2 line-clamp-3 flex-1 text-sm text-gray-700 dark:text-gray-300">
...
<div bind:this={folderElement} class="relative {className}" draggable="true">
  ...
  >
    ...
    <div class="group w-full">
      ...
      >
        <button
          class="dark:hover:bg-gray-850 rounded-lg p-1 text-gray-500 transition-all hover:bg-gray-200 dark:text-gray-500"
          on:click={(e) => {
            e.stopPropagation();
        ...
        >
          {#if folders[folderId]?.meta?.icon}
            <div class="flex transition-all group-hover:hidden">
              <Emoji className="size-3.5" shortCode={folders[folderId].meta.icon} />
            </div>

            <div class="hidden p-[1px] transition-all group-hover:flex">
              {#if open}
        ...
        <div class="line-clamp-1 flex-1 translate-y-[0.5px] justify-start text-start">
          {#if edit}
            <input
              ...
              class="h-full w-full bg-transparent outline-hidden"
            />
          {:else}
            {folders[folderId].name}
          {/if}
        ...
        >
          ...
          >
            <div class="dark:hover:bg-gray-850 touch-auto rounded-lg p-1">
