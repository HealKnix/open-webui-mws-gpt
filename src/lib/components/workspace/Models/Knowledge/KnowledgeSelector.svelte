...
>
  ...
  <div slot="content">
    <div
      class="dark:bg-gray-850 z-[10000] flex w-70 flex-col rounded-2xl border border-gray-200 bg-white p-1.5 text-black shadow-lg dark:border-gray-800 dark:text-white"
    >
      ...
      <div class="flex max-h-56 flex-col gap-0.5 overflow-y-scroll">
        ...
        {:else}
          {#each items as item, i}
            ...
            <div
              class=" selected-command-option-button flex w-full items-center justify-between rounded-xl px-2.5 py-1 text-left text-sm hover:bg-gray-50 hover:dark:bg-gray-800 hover:dark:text-gray-100"
            >
              <button
                class="w-full flex-1"
                type="button"
              ...
              >
                <div class="  flex shrink-0 items-center gap-1 text-black dark:text-gray-100">
                  ...
                  <Tooltip
                    ...
                    tippyOptions={{ zIndex: 100000 }}
                  >
                    <div class="line-clamp-1 flex-1 text-left text-sm">
