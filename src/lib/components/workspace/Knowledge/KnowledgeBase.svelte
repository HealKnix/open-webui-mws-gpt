...
<div class="flex h-full min-h-full w-full flex-col" id="collection-container">
  {#if id && knowledge}
    <AccessControlModal
        ...
        <div class="flex-1">
          <div class="flex w-full items-center justify-between">
            <div class="flex w-full items-center justify-between">
              <input
                type="text"
                class="w-full flex-1 bg-transparent text-left text-lg outline-hidden"
          ...
          <div class="flex w-full">
            <input
              type="text"
              class="w-full bg-transparent text-left text-xs text-gray-500 outline-hidden"
    ...
    <div
      class="dark:border-gray-850/30 -mx-0 mt-2 mb-2.5 flex-1 rounded-3xl border border-gray-100/30 bg-white py-2 dark:bg-gray-900"
    >
      ...
      {#if fileItems !== null && fileItemsTotal !== null}
        <div class="mt-2 flex flex-1 flex-row gap-3 px-2.5">
          <div class="flex flex-1">
            <div class=" flex h-full w-full flex-col space-x-2 rounded-lg">
              <div class="flex h-full min-h-full w-full flex-col">
                {#if fileItems.length > 0}
                  <div class=" scrollbar-hidden flex h-full w-full overflow-y-auto text-xs">
                    <Files
                      files={fileItems}
                      {knowledge}
                      {selectedFileId}
                  ...
                  {/if}
                {:else}
                  <div class="my-3 flex flex-col justify-center text-center text-xs text-gray-500">
                    <div>
              ...
              <div class="flex h-full max-h-full flex-col justify-start">
                <div class=" flex h-full max-h-full w-full flex-col">
                  <div class="flex shrink-0 items-center p-2">
                    <div class="mr-2">
                      <button
                        class="dark:hover:bg-gray-850 w-full rounded-lg p-1.5 text-left text-sm hover:bg-black/5 dark:text-gray-300 dark:hover:text-white"
                    ...
                    <div class=" line-clamp-1 flex-1 text-lg">
                    ...
                    {#if knowledge?.write_access}
                      <div>
                        <button
                          class="flex w-fit self-center rounded-lg px-2.5 py-1 text-sm hover:bg-black/5 disabled:cursor-not-allowed disabled:opacity-50 dark:text-gray-300 dark:hover:bg-white/5 dark:hover:text-white"
                          disabled={isSaving}
                          on:click={() => {
                  ...
                  {#key selectedFile.id}
                    <textarea
                      class="h-full w-full resize-none px-3 py-2 text-sm outline-none"
