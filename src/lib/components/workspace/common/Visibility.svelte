...
<div class=" flex flex-col gap-2 rounded-lg">
  <div class="">
    <div class=" mb-2.5 text-xs font-medium text-gray-500">{$i18n.t('Visibility')}</div>
    ...
    <div class="mb-1 flex items-center gap-2.5">
      ...
      <div>
        <select
          id="models"
          class="block w-fit max-w-full bg-transparent pr-10 text-sm font-medium placeholder-gray-400 outline-hidden"
