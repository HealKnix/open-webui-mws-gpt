...
<div class=" flex flex-col gap-1 rounded-lg">
  <div class="py-2">
    <div class="flex items-center gap-2.5">
      <div>
        <div class=" rounded-full bg-black/5 p-2 dark:bg-white/5">
      ...
      <div>
        ...
        >
          <select
            id="models"
            class="block w-fit max-w-full bg-transparent pr-10 text-sm font-medium placeholder-gray-400 outline-none"
    ...
    {#if hasPublicReadGrant(accessGrants ?? []) && accessRoles.includes('write')}
      <div class="mt-2 ml-0.5 flex w-full justify-between">
  ...
  {#if share}
    <div class="my-1 flex items-center justify-between text-xs font-medium text-gray-500">
      <div>
        {$i18n.t('Access List')}
      </div>
      <div class="flex gap-1">
        <button
          class="flex items-center gap-1 rounded-lg bg-transparent px-2 py-1 text-xs font-medium transition hover:bg-gray-100 dark:hover:bg-gray-800"
          type="button"
          on:click={() => {
    ...
    <div class="flex flex-col gap-2">
      ...
      {#each accessGroups as group}
        <div class="flex w-full items-center justify-between gap-3 pb-1 text-sm transition">
          <div class="flex w-full flex-1 items-center gap-2">
            <!-- Placeholder for group icon vs user icon -->
            <div
              class="dark:bg-gray-850 flex size-5 items-center justify-center rounded-full bg-gray-100 text-xs"
            >
      ...
      {#if shareUsers}
        {#each selectedUsers as user}
          <div
            class="dark:border-gray-850 flex w-full items-center justify-between gap-3 border-b border-gray-50 pb-2 text-sm transition last:border-0"
          >
            <div class="flex w-full flex-1 items-center gap-2">
              <img
