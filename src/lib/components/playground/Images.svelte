      ...
      >
        <div class=" flex h-full w-full flex-col">
          <div class="flex-1 p-1">
                ...
                {#each generatedImages as image, index}
                  ...
                  >
                    <img
                      src={image.url}
                      alt=""
                      class="dark:border-gray-850/30 aspect-square w-full rounded-lg border border-gray-100/30 object-cover"
                    />
                    <div
                      class="absolute inset-0 flex items-center justify-center rounded-lg bg-black/40 opacity-0 transition group-hover:opacity-100"
                    >
                      <svg
            ...
            {:else}
              <div
                class="flex h-full items-center justify-center text-sm text-gray-400 dark:text-gray-600"
              >
        ...
        >
          ...
          <div class="mt-2 flex items-center justify-between gap-2">
            <div class="shrink-0">
              ...
              <button
                type="button"
                class="dark:bg-gray-850 rounded-lg bg-gray-50 px-3.5 py-1.5 text-sm font-medium text-gray-900 transition hover:bg-gray-100 dark:text-gray-200 dark:hover:bg-gray-800"
            ...
            <div class="flex shrink-0 gap-2">
              {#if !loading}
                <button
                  ...
                  class="rounded-lg bg-black px-3.5 py-1.5 text-sm font-medium text-white transition hover:bg-gray-900 disabled:cursor-not-allowed disabled:opacity-50 dark:bg-white dark:text-black dark:hover:bg-gray-100"
