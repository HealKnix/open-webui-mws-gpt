...
{#if filteredItems.length}
  <div
    class="mention-list dark:bg-gray-850 flex w-72 flex-col rounded-2xl border border-gray-200 bg-white p-1 text-black shadow-lg dark:border-gray-800 dark:text-white"
      ...
      {#each filteredItems as item, i}
        ...
        <Tooltip content={item?.id} placement="top-start">
          <button
            ...
            class="flex w-full items-center justify-between rounded-xl px-2.5 py-1.5 text-left {i ===
            selectedIndex
          ...
          >
            {#if item.type === 'channel'}
              <div class=" mr-0.5 flex size-4 items-center justify-center">
