    ...
    <div>
      ...
      <div class="flex w-full flex-col px-4 pb-4 md:flex-row md:space-x-4 dark:text-gray-200">
        <div class=" flex w-full flex-col sm:flex-row sm:justify-center sm:space-x-6">
          <div class="flex h-full w-full flex-col gap-1 pb-2">
            ...
            {:else}
              <div
                class="scrollbar-thin scrollbar-thumb-gray-300 dark:scrollbar-thumb-gray-700 scrollbar-track-transparent flex max-h-[60vh] flex-col gap-2 overflow-y-auto py-2"
              >
