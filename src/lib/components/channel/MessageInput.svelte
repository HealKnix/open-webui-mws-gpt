...
{#if loaded}
  ...
  <div class="bg-transparent">
    <div class="relative inset-x-0 mx-auto max-w-full">
      <div
        class="absolute inset-x-0 top-0 right-0 left-0 mx-auto flex justify-center bg-transparent"
      >
        <div class="flex w-full flex-col px-3">
          ...
          {#if typingUsers.length > 0}
            <div
              class=" -mt-7 bg-gradient-to-t to-transparent pb-2.5 {typingUsersClassName} pointer-events-none select-none"
            >
              <div class=" mt-1.5 flex items-center gap-1.5 px-1 text-xs">
                <Skeleton size="xs" />
      ...
      <div
        class="{disabled ? 'pointer-events-none cursor-not-allowed opacity-50' : ''} relative z-20"
      >
        {#if recording}
          <VoiceRecording
            bind:recording
        ...
        {:else}
          ...
          >
            <div
              ...
              class="dark:border-gray-850/30 relative flex w-full flex-1 flex-col rounded-3xl border border-gray-50 bg-white/90 px-1 shadow-lg transition focus-within:border-gray-100 hover:border-gray-100 dark:bg-gray-400/5 dark:text-gray-100 focus-within:dark:border-gray-800 hover:dark:border-gray-800"
              dir={$settings?.chatDirection ?? 'auto'}
            >
              {#if replyToMessage !== null}
                <div class="z-10 flex w-full flex-col px-3 pt-3 text-left">
                  <div class="flex w-full items-center justify-between">
                    <div class="flex items-center gap-2 pl-[1px] text-sm">
                    ...
                    {#if file.type === 'image' || (file?.content_type ?? '').startsWith('image/')}
                      ...
                      <div class=" group relative">
                        ...
                        <div class=" absolute -top-1 -right-1">
                          <button
                            class=" invisible rounded-full border border-white bg-white text-black transition group-hover:visible"
                            type="button"
                            on:click={() => {
              ...
              <div class="px-2.5">
                <div
                  class="scrollbar-hidden h-fit max-h-96 w-full resize-none overflow-auto bg-transparent px-1 pt-2.5 pb-[5px] outline-hidden ltr:text-left rtl:text-right dark:text-gray-100"
                >
              ...
              <div class=" mx-0.5 mb-2.5 flex justify-between">
                <div class="ml-1 flex flex-1 space-x-1 self-end">
                  <slot name="menu">
                    {#if acceptFiles}
                      <InputMenu
                      ...
                      >
                        <button
                          ...
                          class="rounded-full bg-transparent p-1.5 text-gray-800 outline-hidden transition hover:bg-white/80 focus:outline-hidden dark:text-white dark:hover:bg-gray-800"
                          type="button"
                          aria-label="More"
                        >
                          <svg
                ...
                <div class="mr-1 flex space-x-1 self-end">
                  {#if content === ''}
                    <Tooltip content={$i18n.t('Record voice')}>
                      ...
                      >
                        <svg
                          ...
                          viewBox="0 0 20 20"
                          fill="currentColor"
                          class="h-5 w-5 translate-y-[0.5px]"
                        >
