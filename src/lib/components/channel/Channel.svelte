...
>
  <PaneGroup direction="horizontal" class="h-full w-full">
    <Pane defaultSize={50} minSize={50} class="relative flex h-full w-full flex-col">
      <Navbar
        {channel}
      ...
      {#if channel && messages !== null}
        <div class="flex-1 overflow-y-auto">
          <div
            class=" scrollbar-hidden z-10 flex h-full w-full max-w-full flex-1 flex-col-reverse overflow-auto pt-6 pb-2.5"
