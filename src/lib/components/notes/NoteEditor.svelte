...
<PaneGroup direction="horizontal" class="h-full w-full">
  <Pane defaultSize={70} minSize={30} class="relative flex h-full w-full flex-col">
    <div class="relative flex h-full w-full flex-1 justify-center pt-[11px]" id="note-editor">
      {#if loading}
      ...
      {:else}
        <div class=" flex w-full flex-col {loading ? 'opacity-20' : ''}">
          <div class="mb-1.5 flex w-full shrink-0 items-center justify-between px-3.5">
            <div class="flex w-full min-w-0 items-center">
              {#if $mobile}
                <div
                  class="{$showSidebar
                    ? 'pl-0.5 md:hidden'
                    : ''} flex flex-none -translate-x-1 items-center pr-1"
                >
                  <Tooltip
              ...
              <input
                class="w-full bg-transparent text-2xl font-medium outline-hidden"
                type="text"
              ...
              {#if titleInputFocused && !titleGenerating}
                <div
                  class="z-10 flex -translate-x-[0.5px] translate-y-[0.5px] items-center space-x-1.5 self-center pl-2"
                >
              ...
              <div class="flex shrink-0 translate-x-1 items-center gap-0.5">
                {#if note?.write_access}
                  {#if editor}
                    <div>
                      <div class="flex min-w-fit items-center gap-0.5 self-center" dir="ltr">
                        <button
                          class="self-center rounded-md p-1 transition hover:enabled:bg-black/5 hover:enabled:text-black disabled:cursor-not-allowed disabled:text-gray-500 disabled:hover:text-gray-500 dark:hover:enabled:bg-white/5 dark:hover:enabled:text-white"
                          on:click={() => {
                  ...
                  <Tooltip placement="top" content={$i18n.t('Chat')} className="cursor-pointer">
                    <button
                      class="rounded-lg bg-transparent p-1.5 transition hover:bg-white/5"
                      on:click={() => {
                ...
                >
                  <div class="rounded-lg bg-transparent p-1 transition hover:bg-white/5">
                ...
                {#if note?.write_access}
                  <button
                    class="dark:bg-gray-850 flex shrink-0 items-center gap-1.5 rounded-full bg-gray-50 px-2.5 py-1 text-sm text-black transition hover:bg-gray-100 dark:text-white dark:hover:bg-gray-800"
                    on:click={() => {
                ...
                {:else}
                  <div class="shrink-0 px-2 py-1 text-xs text-gray-500">
          ...
          <div class="  px-2.5">
            ...
            >
              <div
                class="flex w-fit items-center gap-0.5 text-xs font-medium text-gray-500 dark:text-gray-500"
              >
                <button class=" flex w-fit min-w-fit items-center gap-1 rounded-lg px-1.5 py-1">
                ...
                {#if editor}
                  <div class="flex min-w-fit items-center gap-1 px-1">
                    <div>
                      {$i18n.t('{{COUNT}} words', {
                        COUNT: wordCount,
                      })}
          ...
          <div
            class=" relative h-full w-full flex-1 overflow-auto px-3.5"
            id="note-content-container"
          >
            {#if editing}
              <div
                class="fixed top-0 left-0 h-full w-full {streaming
                  ? ''
                  : ' bg-white/10  backdrop-blur-xs dark:bg-gray-900/10'} z-10 flex cursor-not-allowed items-center justify-center"
              ></div>
            {/if}
    ...
    <div class="absolute right-0 bottom-0 z-50 flex p-3.5 select-none">
      <div class="flex flex-col justify-end gap-2">
        ...
        {:else}
          <div
            class="dark:border-gray-850/30 dark:bg-gray-850 flex cursor-pointer gap-0.5 rounded-full border border-gray-50 shadow-xl transition"
          >
            <Tooltip content={$i18n.t('AI')} placement="top">
              {#if editing}
                <button
                  class="flex shrink-0 items-center justify-center rounded-full p-2 transition hover:bg-gray-50 dark:hover:bg-gray-800"
                  on:click={() => {
                    stopResponseHandler();
                  }}
                  type="button"
              ...
              {:else}
                ...
                >
                  <div
                    class="dark:bg-gray-850 flex cursor-pointer rounded-full border border-gray-50 bg-white p-2.5 shadow-xl transition hover:bg-gray-50 dark:border-none dark:hover:bg-gray-800"
                  >
                    <SparklesSolid />
                  </div>
                </AiMenu>
